...
MERCHANT_SUBSCRIPTION_NOTICE_AR = (
    'تحصل على 30 يوماً مجاناً من تاريخ إنشاء حسابك لعرض متجرك على الخريطة وصفحة المتجر ومنتجاتك. '
    'بعد انتهائها لن يظهر متجرك للمتسوّقين حتى تُكمل دفع الاشتراك الشهري وتوافق الإدارة على الطلب؛ '
    'عند القبول يُمدَّد الاشتراك 30 يوماً، وهكذا في كل تجديد.'
)
