...
urlpatterns = [
    ...
    path('auth/google/', GoogleIdTokenLoginView.as_view(), name='auth_google_id_token'),
    path('auth/google/access-token/', GoogleAccessTokenLoginView.as_view(), name='auth_google_access_token'),
